...
$_['text_success']       = 'PayPal Payment Pro (UK) erfolgreich geändert!';
...
// Entry
$_['entry_vendor']       = 'Lieferant:<br /><span class="help">Die Lieferantennummer zum Login auf PayPal Payments Pro (UK).</span>';
...
$_['entry_password']     = 'Passwort:<br /><span class="help">Das 6 bis 32 Zeichen lange Passwort, dass während der Registrierung definiert wurde.</span>';
...
// Error
$_['error_permission']        = 'Warnung: Keine Berechtigung, um PayPal Payment Pro (UK) zu ändern!';
