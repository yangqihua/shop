...
$_['entry_sku']					= 'SKU:';
$_['entry_location']			= 'anderer Ort:';
$_['entry_manufacturer']		= 'Hersteller:';
$_['entry_shipping']			= 'Erfordert Versand:';
$_['entry_date_available']		= 'Verfügbarkeitsdatum:';
$_['entry_quantity']			= 'Lagerbestand:';
$_['entry_minimum']				= 'Mindestbestellmenge:<span class="help">Mindestmenge welche bestellt werden muss</span>';
$_['entry_maximum']          = 'Höchstmenge:<br/><span class="help">Begrenzt die maximal mögliche Bestellmenge (0 für unbegrenzt)</span>';
...
$_['entry_cost']				= 'Wareneinsatz:<span class="help">Nettowarenwert (Verwendung bei der Margenberechnung)</span>';
$_['entry_price']				= 'Preis:';
$_['entry_subtract']			= 'Vom Lagerbestand abziehen:';
$_['entry_weight_class']		= 'Gewichtseinheit:';
$_['entry_weight']				= 'Gewicht:';
$_['entry_length']           	= 'Längeneinheit:';
$_['entry_dimension']			= 'Abmessungen (L x B x H):';
$_['entry_image']				= 'Bild:<br /><span class="help">Das Bild anklicken, um es zu ändern.</span>';
...
$_['entry_tags']				= 'Produkt Tags:<span class="help">Begriffe für Tagmodul (jeweils getrennt durch Komma)</span>';

// Error
$_['error_permission']       = 'Warnung: Keine Berechtigung um Produkte zu verändern!';
$_['error_name']				= 'Produktname muss zwischen 3 und 255 Buchstaben lang sein!';
$_['error_model']				= 'Modell muss zwischen 3 und 24 Zeichen lang sein!';
