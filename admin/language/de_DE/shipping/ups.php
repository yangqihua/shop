...
$_['text_regular_daily_pickup']    = 'Tägliche Abholung';
...
$_['entry_packaging']              = 'Versandverpackung:<span class="help">Welche Versandverpackung wird verwendet?</span>';
$_['entry_classification']         = 'Kundenklassifizierungscode:<span class="help"> 01 - Wenn Rechnung über UPS-Konto und tägl. Abholung, 03 - Kein UPS-Konto oder Rechnung über UPS-Konto aber keine tägl. Abholung, 04 - Wenn Versand über UPS-Geschäft (nur wenn Ursprung in USA)</span>';
...
$_['entry_state']                  = 'Herkunftsbundesland:<span class="help"> 2-Zeichenabkürzung des Herkunftsbundeslandes (nur US).</span>';
...
$_['entry_test']                   = 'Testmodus:<br /><span class="help">Verwende dieses Modul im Test- (JA) oder Livemodus (Nein)?</span>';
$_['entry_quote_type']             = 'Anfrageart:<span class="help"> Anfrage für private oder geschäftliche Lieferung.</span>';
$_['entry_service']                = 'Dienste:<span class="help"> Welche UPS-Dienste werden angeboten.</span>';
$_['entry_insurance']              = 'Versicherung:<span class="help">Versicherung mit Produktsumme als Wert aktivieren</span>';
$_['entry_display_weight']    = 'Liefergewicht:<br /><span class="help"> Soll das Liefergewicht angezeigt werden (z.B. 3,27 kg)</span>';
$_['entry_measurement_code']       = 'Maßeinheit:<br /><span class="help">Bitte die Maßeinheit mit dem Maßsystem abgleichen.</span>';
$_['entry_measurement_class']      = 'Maßsystem:<span class="help">Bitte metrisches oder englisches System wählen.</span>';
$_['entry_dimension']			   = 'Maße (L x B x H):';
$_['entry_weight_code']            = 'Gewichtseinheit:<span class="help"> Zwischen kg und lbs wählen. Bitte sicherstellen, das nur erlaubte Gewichtseinheiten verwendet werden.</span>';
$_['entry_weight_class']           = 'Gewichtseinheit:<span class="help"> Zwischen Kilogramm und Pfund wählen.</span>';
...
// Error
$_['error_permission']        = 'Warnung: Keine Berechtigung, um UPS (US) zu ändern!';
