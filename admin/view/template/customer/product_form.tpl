        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
             ...
             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-amazonurl"><span data-toggle="tooltip" title="">Amazon url</span></label>
                <div class="col-sm-10">
                  <input type="text" name="amazonurl" value="<?php echo $amazonurl; ?>" id="input-amazonurl" class="form-control" />
                </div>
              </div>
              <div class="form-group">
